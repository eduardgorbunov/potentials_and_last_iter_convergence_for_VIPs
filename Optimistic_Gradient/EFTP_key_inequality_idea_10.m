...
for N = 2:Nmax
    ...
    objective = (bargk(:,end-1))'*G*(bargk(:,end-1)) + 2*(bargk(:,end-1)-bargk(:,end-2))'*G*(bargk(:,end-1)-bargk(:,end-2)) - (bargk(:,end-3))'*G*(bargk(:,end-3)) - 2*(bargk(:,end-3)-bargk(:,end-4))'*G*(bargk(:,end-3)-bargk(:,end-4));
    ...
    save(strcat('dump/EFTP_key_ineq_idea_10_dist_2_res_L_1_N_', sprintf('%d_', N), sprintf('_%f', gamma),'.mat'), 'res_norm', 'gamma');
    ...
    save(strcat('dump/EFTP_key_ineq_idea_10_dist_2_dual_variables_L_', sprintf('%d_', L), sprintf('N_%d_', N), sprintf('_%f', gamma),'.mat'), 'res_norm', 'gamma', 'monotonicity_weights', 'Lipschitzness_weights');
    %fprintf("======================================================\n");
end